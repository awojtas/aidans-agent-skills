...
description: 'Creates a high-level solution design at docs/design/solution-design.md — a combined business + technical first-stab at how the system might work — via a short focused interview (~10-15 min) covering purpose, users, value, features, user flows, C4 context/container diagrams, data, integrations, NFR drivers, constraints, and risks. Explicitly first-thinking fidelity (supersede notes accumulate). Bridges README and docs/architecture/. Trigger phrases: "solution design", "create a solution design", "draft an HLD", "high-level design", "sketch the solution", "design overview", "vision doc".'
---
