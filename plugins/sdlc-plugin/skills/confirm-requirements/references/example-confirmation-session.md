...
A before/after walkthrough of one confirmation session. The starting state is taken from the sibling `repo-requirements` skill's example: `../repo-requirements/references/example-worked-requirement.md` — the GitHub Preview/Code/Blame toggle case.
