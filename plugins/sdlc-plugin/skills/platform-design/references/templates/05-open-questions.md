...
The point of capturing them: future work (`/requirements-create-from-design`, `/tasks-create-from-requirements`, `/task-implement`) can be honest about what's not yet decided. Don't bury these in prose.
