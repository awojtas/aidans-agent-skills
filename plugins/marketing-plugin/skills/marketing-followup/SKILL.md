...
Launches spike then fade. This is the boring, sustainable part that compounds — sized to the owner's real weekly time.

## When to use

Post-launch, ongoing. The recurring phase of the lifecycle.

## Process

1. **Read `profile.md`** for the weekly time budget and scale to it.
2. **Run a small rotating weekly slot** (one focused session), e.g.:
   - approve a batch of drafted posts (the agent drafts; human approves/schedules)
