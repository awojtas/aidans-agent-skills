---
name: requirements-rework
description: 'Course-corrects existing requirements docs and GitHub issues after a discovery invalidates the original plan. Use for pivots, rework, changed direction, or cleanup of stale requirements and tasks, with explicit approval before destructive edits.'
---
